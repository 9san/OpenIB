...
function addButton(post) {
	...
	$ele.find('input.delete').after(
		$('<a>', {href: '#', class: 'post-btn', title: 'Post menu'}).html('<i class="fa fa-play"></i>')
	);
}
...
cssString =
	...
	'.post-menu ul {\n' +
	'    background-color:#D6DAF0; border: 1px solid #666;\n' +
	...
	'.post-btn {transition: transform 0.1s; width: 15px; text-align: center; font-size: 10pt; opacity: 0.8; text-decoration: none; margin: -6px 2px 0px -5px !important; display: inline-block;}\n' +
